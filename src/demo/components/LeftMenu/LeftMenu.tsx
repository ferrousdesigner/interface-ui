        ...
        <div className="left-menu-demo-section">
          <div
            className={`left-menu-item ${
              activeComponent === "Get Started" ? "active" : ""
            }`}
            onClick={() => setActiveComponent("Get Started")}
          >
            <div className="left-menu-item-text">Get Started</div>
          </div>
          <div
            className={`left-menu-item ${
              activeComponent === "Installation" ? "active" : ""
            }`}
            onClick={() => setActiveComponent("Installation")}
          >
            <div className="left-menu-item-text">Installation</div>
          </div>
          <div
            className={`left-menu-item ${
              activeComponent === "Demo" ? "active" : ""
            }`}
        ...
        <div className="left-menu-components-section">
          {components.map((component) => (
            <div
              key={component.name}
              className={`left-menu-item ${
                activeComponent === component.name ? "active" : ""
              }`}
